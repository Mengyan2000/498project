...
def get_model(model_usr_configs):
    ...
    print("in get_model function, before quant_model")
    
    if model_usr_configs.quant_model:
        print("in get_model, inside if statement")
...
def get_trainer(trainer_usr_configs):
    ...
    print("get_trainer, ", trainer_usr_configs.trainer)
